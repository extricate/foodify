...
<div
    ...
    @endif
     class="img-recipe">
        <a href="@if( $foodplan_day != null) {{ route('recipes.show', $foodplan_day->id) }} @else {{ route('recipes.index') }} @endif" class="btn btn-default img-overlay text-light text-capitalize font-weight-bold">
            {{ substr($day, 0, 2) }}
        </a>
</div>
