<div class="card mt-3 mb-3">
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <textarea type="text" class="form-control form-textarea mde-editor" id="text" name="text" placeholder="Write your comment here" rows="4" maxlength="400">{{ old('text') }}</textarea>
        </div>
